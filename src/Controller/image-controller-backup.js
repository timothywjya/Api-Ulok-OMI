        ...
        await db.transaction(async trx => {
            try {
                ...
                for (const photo of photos) {
                    ...
                    const uniqueFilename = `${NodeHashIds.encodeFileName([parentId, timestamp])}${fileExtension}`;
                ...
                if (dataToInsert.length > 0) {
                    await trx('images').insert(dataToInsert);
                }
                ...
                return next(new CustomError(
                    ...
                    400,
                    'Error',
                    error.message || 'Failed to replace images, please try again.'
                ));
            }
        });
    }
